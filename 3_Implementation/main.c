...
int main() {
  ...
  if(List == '1'){
      ...
      printf("1.Fahrenheit °F to Celsius °C. \n");
      printf("2.Celsius °C to Fahrenheit °F. \n");
      ...
      if(temp == 1){
        ...
        printf("Enter the Celcius °C: \n");
        scanf("%d",&inputC);
        CelsiusToFahrenheit = ((9.0/5.0)*inputC + 32);
        printf("Fahrenheit °F: %.2f",CelsiusToFahrenheit);
      }
      else if(temp == 3){
        printf("Enter the Celcius °C: \n");
        scanf("%d",&inputC);
